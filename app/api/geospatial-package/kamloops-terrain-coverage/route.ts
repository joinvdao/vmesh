...
async function classifySample({
  ...
  return {
    ...
    rasterSourceVerified: preflight.rasterSourceVerified,
    rawLidarArchiveBacked: preflight.rawLidarArchiveBacked,
    rawLidarZipVerified: preflight.rawLidarZipVerified,
    missingRasterCellsRawLidarVerified: preflight.missingRasterCellsRawLidarVerified,
    rawLidarDtmMaterializerReady: preflight.rawLidarDtmMaterializerReady,
