      ...
      <div
        className={`pointer-events-none absolute inset-0 transition-colors duration-500 ${
          globeTheme === "dark"
            ...
            : "bg-[radial-gradient(circle_at_50%_44%,rgba(135,217,226,0.34),transparent_29%),radial-gradient(circle_at_50%_54%,rgba(255,255,255,0.24)_0,rgba(234,246,245,0.72)_48%,rgba(221,237,238,0.96)_82%),linear-gradient(180deg,#FFFFFF_0%,#e8f3f2_78%)]"
        }`}
      />
