...
const TerrainGlobe = dynamic(
  () => import("@/components/Map/TerrainGlobe").then((mod) => mod.TerrainGlobe),
  {
    ssr: false,
    loading: () => (
      <div className="flex h-full w-full items-center justify-center bg-[#f7faf9] text-sm text-[#6f7d88]">
