...
function validateBase(manifest, summary) {
  ...
  for (const [index, record] of summary.records.entries()) {
    ...
    finite(record.forecast.stressScore, `${prefix}.forecast.stressScore`, errors, 0, 100);
    finite(
    ...
    finite(record.flood.exposureScore, `${prefix}.flood.exposureScore`, errors, 0, 100);
    finite(record.fire.exposureScore, `${prefix}.fire.exposureScore`, errors, 0, 100);
    finite(record.solar.practicalityScore, `${prefix}.solar.practicalityScore`, errors, 0, 100);
