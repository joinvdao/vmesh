...
describe("deferred analysis provider registry and Open-Meteo parsing", () => {
  it("selects Open-Meteo as the live-capable no-secret deferred provider", () => {
  ...
  it("parses Open-Meteo fixtures into a macro cell summary with provenance", () => {
    ...
    expect(summary?.forecast.dominantCondition).toBeTypeOf("string");
  });
