...
export function getOpenDataPackageSources(
  ...
  return [
    ...
    source({
      id: "mapbox-optional",
      label: "Mapbox optional basemap/satellite comparison",
      ...
      sourceUrl: "mapbox://optional-token-gated",
      ...
      limitations: ["Not an open-source default; do not commit tokens or paid-provider URLs."],
      notes: "Optional comparison source only when a deployment explicitly accepts terms."
    })
  ];
}
