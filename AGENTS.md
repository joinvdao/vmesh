...
- Treat this repository as private/internal-first until an owner-approved
  public-release split exists. Do not publish, mirror, package, or describe this
  repo as open-source-ready.
...
- This VMesh repo is private/internal-first.
- Keep any future public repo focused on sanitized app code, schemas, fixtures,
  generic source-broker contracts, and public-safe docs.
- Keep private planning systems, local ticket folders, personal notes,
  unpublished operational context, source-discovery strategy, Intel Tools run
  outputs, worker topology, private eval-site context, and BA-specific package
  compiler logic out of any public release.
- Do not commit private planning exports, personal task systems, local ticket
  folders, local vault metadata, exact private coordinates, signed URLs,
  provider order details, or raw sidecar outputs.
- Use public GitHub issues only for roadmap items and implementation work that
  has passed the public-release split review.
